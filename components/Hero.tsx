    ...
    <div className='pb-20 pt-36'>
        ...
        <div className='flex justify-center relative my-20'>
            <div className='max-w-[89vw] md:max-w-2xl lg:maxw-[60vw] flex flex-col items-center justify-center'>
                <h2 className='uppercase tracking-widest text-sm text-center text-blue-100 max-w80'>
                    Crafting Exceptional Web Experiences
                </h2>
                <TextGenerateEffect
                    className='text-center text-[40px] md:text-5xl lg:text-6xl'
                    words='Turning Ideas into Digital Solutions'
                />
                <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                    Hi, I&apos;m Renato, A Fullstack Developer based in Philippines.
                </p>
